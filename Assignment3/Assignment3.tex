...
\end{multline}
\begin{multline}
	{\norm{\vec{A-C}}}^2 +{\norm{\vec{B-D}}}^2 = \\{\norm{\vec{A-D}}}^2 +{\norm{\vec{D-C}}}^2+2\norm{\vec{A-D}} \norm{\vec{D-C}}+\\ {\norm{\vec{A-D}}}^2+{\norm{\vec{A-B}}}^2-2\norm{\vec{A-D}} \norm{\vec{A-B}}\label{eq:2}
\end{multline}

In the parallelogram $ABCD$  
\begin{align}
	\norm{\vec{A-D}}=\norm{\vec{B-C}}\label{eq:3}\\
	\norm{\vec{A-B}} = \norm{\vec{D-C}}\label{eq:4}
\end{align}
Simplifying equation \eqref{eq:2},\eqref{eq:3}  and \eqref{eq:4}
\begin{multline}
	\norm{\vec{A-C}}^2 + \norm{\vec{B-D}}^2 =\\ \norm{\vec{A-B}}^2+\norm{\vec{B-C}}^2+\norm{\vec{D-C}}^2+\norm{\vec{A-D}}^2\label{eq:5}
\end{multline}
The equations \eqref{eq:1}  and \eqref{eq:5} are same,hence proved
\end{document}